...
export default function Resume() {
  ...
  if (formData) 
  {
    axios.post('http://localhost:8080/auth/postdetail', formData)
    .then(() => {
      // Handle success
      console.log("success");
    })
  ...
  const handleTogglePreview = () => {
    axios.post('http://localhost:8080/auth/postresume', formData)
      .then(() => {
        // Handle success
...
<h2>RESUME GENERATOR</h2>
    ...
    <div className="resume-container">
      <form className="input-fields">
        ...
        <div className="btn">
          <button className='resb' onClick={handleTogglePreview}>Done</button>
          </div>
      </form>
