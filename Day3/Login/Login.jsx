...
export default function Login() {
  ...
  return (
    ...
    <input type="email" value={user} placeholder="EMAIL-ID" onChange={e=>setEmail(e.target.value)}/><br/>
    <div>
    {error && user.length===0?
    ...
    <input type={showPassword ? "email" : "password"} value={pwd} placeholder="PASSWORD" onChange={e => setPassword(e.target.value)} />
