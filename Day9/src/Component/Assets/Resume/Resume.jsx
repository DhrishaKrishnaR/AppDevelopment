...
<h2>RESUME GENERATOR</h2>
    ...
    <div className="resume-container">
      <form className="input-fields">
        ...
        <input type="text" className="in" name="name" placeholder="Name" onChange={handleChange} />
        <input type="text" className="in" name="mob" placeholder="Mobile Number" onChange={handleChange} />
